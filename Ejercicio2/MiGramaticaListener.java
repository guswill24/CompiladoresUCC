...
public interface MiGramaticaListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@link MiGramaticaParser#ifElseStmt}.
	 * @param ctx the parse tree
	 */
	void enterIfElse(MiGramaticaParser.IfElseContext ctx);
	/**
	 * Exit a parse tree produced by the {@code IfElse}
	 * labeled alternative in {@link MiGramaticaParser#ifElseStmt}.
	 * @param ctx the parse tree
	 */
	void exitIfElse(MiGramaticaParser.IfElseContext ctx);
	/**
	 * Enter a parse tree produced by the {@code CondicionSimple}
	 * labeled alternative in {@link MiGramaticaParser#condicion}.
	 * @param ctx the parse tree
	 */
	void enterCondicionSimple(MiGramaticaParser.CondicionSimpleContext ctx);
	/**
	 * Exit a parse tree produced by the {@code CondicionSimple}
	 * labeled alternative in {@link MiGramaticaParser#condicion}.
	 * @param ctx the parse tree
	 */
	void exitCondicionSimple(MiGramaticaParser.CondicionSimpleContext ctx);
	/**
